...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    jc .A20GATEERROR  ; A20 게이트 활성화 성공여부 확인
    jmp .A20GATESUCCESS

.A20GATEERROR
    ; 에러 발생 시, 시스템 컨트롤 포트로 전환 시도.
    in al, 0x92    ; 시스템 컨트롤 포트(0x92)에서 1 바이트를 읽어 AL regi에 저장 
    or al, 0x02     ; 읽은 값에 A20 게이트 비트(bit[1]를 set
    and al, 0xfe    ; 시스템 reset 방지를 위해 0xfe와 and연산하여 bit[0]를 clear
    out 0x92, al    ; 시스템 컨트롤 포트(0x92)에 변경된 값을 설정.
