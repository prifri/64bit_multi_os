...
int main(int argc, char* argv[])
{
    ...
    //--------------------------------------------------------------------------
    // 64bit kernel file을 열어서 모든 내용을 disk image file로 copy
    //--------------------------------------------------------------------------
...
/*
 * PRIFI, 2022.05.16:
 * - BootLoader의 sector 개수 정보를 직접 변경한다.
 */
							 ...
							 int iKernel32SectorCount)
{
    ...
    printf( "[INFO] Total sector of protected mode kernel[%d]\n", 
        iKernel32SectorCount );
}
